        ...
        const Icons = {
            ...
            Network: () => (
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17a3 3 0 11-6 0 3 3 0 016 0zm0 0v-6a3 3 0 013-3h0a3 3 0 013 3v6m0 0a3 3 0 11-6 0 3 3 0 016 0zm6-6a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
            ),
            RotateCw: () => (
