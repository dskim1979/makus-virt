...
# GitHub URLs
GITHUB_VERSION_URL = "https://raw.githubusercontent.com/dskim1979/makus-virt/main/version.json"
GITHUB_REPO_URL = "https://github.com/dskim1979/makus-virt"
GITHUB_RAW_URL = "https://raw.githubusercontent.com/dskim1979/makus-virt/main"
# NS: auto-generated by GitHub, no manual release needed
GITHUB_ARCHIVE_URL = "https://github.com/dskim1979/makus-virt/archive/refs/heads/main.tar.gz"

# NS: Makus Virt has no separate mirror infrastructure (unlike upstream's
# updates.pegaprox.com) — point the "mirror" fallback at the same GitHub
# endpoints so the existing [primary, mirror] retry logic in settings.py /
# alerts.py still works without every call site needing a rewrite, instead
# of silently trying to reach a domain we don't control.
MIRROR_RAW_URL = GITHUB_RAW_URL
MIRROR_VERSION_URL = GITHUB_VERSION_URL
MIRROR_ARCHIVE_URL = GITHUB_ARCHIVE_URL
